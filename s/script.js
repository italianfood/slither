...
function showFPS() {
	if (typeof playing != "undefined" && fps && lrd_mtm) {
...
function checkForMods() {
	return $("#ip-hud").length != 0 || $("#worms").length != 0;
}
...
$(function(){
	...
	setTimeout('checkForMods()', 2000);
});

$("#playh .btnt.nsi.sadg1").click(function(){setTimeout(function(ip){if ((!ws || ws.readyState != ws.OPEN) && window.bso.ip == ip){alert("Server is full or it's turned off! Looking for a new server...");document.location.href = "http://slither.io/";}}, 5000, bso.ip)});
